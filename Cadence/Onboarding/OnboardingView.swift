        ...
        VStack(alignment: .leading, spacing: 0) {
            ...
            ScrollView {
                VStack(alignment: .leading, spacing: 16) {
                    permissionCard(
                        title: "Microphone",
                        detail: "Cadence records only while you hold the hotkey. Audio never leaves this Mac.",
                    ...
                    permissionCard(
                        title: "Accessibility",
                        detail: "Needed to paste into the app you are already typing in, and to listen for the dictation hotkey.",
